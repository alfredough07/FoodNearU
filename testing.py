...
# Get inputs
geocode = gmaps.geocode(input("Please enter your current location (street address, cite, state): ")) # 411 N State St, Ann Arbor, MI
...
places = gmaps.places(location=geocode[0]['geometry']['location'], radius=rad, type='restaurant')
